...
- [x] Add Celery for asynchronous tasks such as sending emails for confirmation/password reset.
...
- [x] Fix the error with pgadmin (not working after adding nginx.).
- [x] Add Celery for asynchronous backend tasks.
